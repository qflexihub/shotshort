export const ProductVideoHeader = {
  title: "Sell more with personable product videos",
  description:
...
export const productVideohappyClients = {
  heading: "Clients that speak for us",
};

export const productVideoServices = {
  contentHeading: {
    title: "Product Highlighting Video Production Services For E-commerce",
    subtitle:
      "At ShotShort, we focus on UGC and emotionally inclined stories that help you skyrocket your sales and build a loyal community. Trust us to spotlight your product and improve your sales ROI.",
  },
  bgImage: "",
  services: [
    {
      id: 1,
      title: "What Sets Our Product Videos Apart?",
      description:
        "Our video conceptualization is based on the interest of the audience, we create stories that speak louder, entertain the masses, and highlight your product’s USPs so that they can shine brighter in the market, making them highly effective in skyrocketing your e-commerce sales.",
      image: "/smv.svg",
      buttonText: "",
    },
  ],
